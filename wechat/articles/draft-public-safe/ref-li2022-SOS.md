...
![图 1 半潜式浮式风机的构型](../../assets/public-safe/ref-li2022-SOS/fig-01-configuration.png)
...
![图 10 FAST 仿真器框架](../../assets/public-safe/ref-li2022-SOS/fig-10-fast-framework.png)
...
其中，$T$ 是浮体横摇或纵摇固有周期，$I$ 是转动惯量，$D$ 是浮体排水量，$h_T$ 是稳心高度。这个关系说明：当结构重心降低、稳心高度增大时，横摇/纵摇固有周期会缩短。对这篇论文而言，HSP3 钢平台因为需要更多压载水达到相同吃水，重心低于 LCP3 混凝土平台，从而带来不同的纵摇动力响应。
...
这一重心差异直接影响横摇和纵摇固有周期。自由衰减试验显示，HSP3 的横摇/纵摇固有周期比 LCP3 约短 $1.6\,\mathrm{s}$。在风单独作用下，HSP3 抵抗倾覆力矩的能力更强；论文结论中指出，在额定运行风况下，HSP3 的平均平台纵摇角比 LCP3 小约 $0.5^\circ$。
...
![图 12 LCP3 与 HSP3 模型的响应幅值算子对比](../../assets/public-safe/ref-li2022-SOS/fig-12-rao-comparisons.png)
...
![图 26 组合随机风浪条件下风机结构动力学统计数据](../../assets/public-safe/ref-li2022-SOS/fig-26-structural-dynamics-statistics.png)
...
- 模型试验采用 $1{:}60$ 比尺，并使用等效拖曳盘模拟平均风推力；
