...
WOEAI 的研究方向按两条公开主方向组织。

- :doc:`建筑结构抗风 Structural Wind Engineering <BuildingStructuralWindResistance>`：建筑和相关工程结构的强风作用、风环境建模、风荷载、结构响应、优化与控制问题。
- :doc:`海上漂浮风电 Floating Offshore Wind Turbine <FloatingOffshoreWindEnergy>`：浮式风机系统、浮式混凝土平台、风浪流环境作用和数值风浪流水池的分析、试验与优化问题。
