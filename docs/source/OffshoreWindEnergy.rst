...
海上风电方向关注浮式风机系统、半潜式基础、风浪联合响应、结构优化和运动/振动控制。研究工作连接海洋环境作用、结构动力学、数值优化和物理模型试验。

浮式风机系统优化 Floating Wind Turbine Optimization
------------------------------------------------------------

团队公开项目和论文记录中包含浮式风机系统一体化分析与优化、半潜式风机基础结构设计、长期动力响应优化和制造成本/水动力敏感性等问题。
...
运动和振动控制 Motion And Vibration Control
-------------------------------------------
