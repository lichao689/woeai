...
Lingwei Chen：概念化，形式分析，方法学，软件，验证，可视化，初稿撰写，审阅与编辑。

Chao Li：概念化，资金获取，方法学，项目管理，验证，初稿撰写，审阅与编辑。

Jinghan Wang：概念化，方法学，软件，验证，可视化，初稿撰写，审阅与编辑。

Gang Hu：初稿撰写，审阅与编辑，概念化。

Yiqing Xiao：概念化，资金获取，项目管理，监督。
...
本研究得到广东省基础与应用基础研究基金（2022A1515240062、2022A1515240001、2022A1515140136）和深圳市科技计划项目（KQTD20210811090112003）的支持，作者对此表示感谢。作者感谢 Dr. Tony Saad 和 Dr. Yunzhu Cai 分享他们的开源代码与数据，地址分别为 https://turbulence.utah.edu/ 和 https://doi.org/10.24433/CO.5923657.v3，因为其算法和数值模拟在本研究中被用于对比。

补充材料
--------

与本文相关的补充材料可在在线版本中找到，DOI 为 10.1016/j.jcp.2023.112706。
