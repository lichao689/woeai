...
![论文图 1 半潜式浮式风机的构型](../../assets/public-safe/ref-li2022-SOS/fig-01-configuration.png)
...
这篇论文比较同一座 Y 型半潜式浮式风机在混凝土平台和钢平台两种材料方案下的动力响应。
它重要，因为材料选择不仅改变建造和维护，也会改变重心、回复刚度、固有周期、塔底载荷和机舱加速度。
读者可以带走的结论是：钢平台和混凝土平台各有动力学优势，材料选型必须放到风浪耦合响应和目标海况中判断。

## 关键数字 / 关键结论卡

- 研究对象是 $5\,\mathrm{MW}$ Y 型半潜式浮式风机，并通过 $1{:}60$ 比尺风浪联合模型试验和耦合仿真互相校验。
- 自由衰减试验显示，HSP3 钢平台的横摇/纵摇固有周期比 LCP3 混凝土平台约短 $1.6\,\mathrm{s}$。
- 在额定运行风况下，HSP3 的平均平台纵摇角比 LCP3 小约 $0.5^\circ$，但波频响应中仍可能出现相反趋势。
...
混凝土和钢半潜式平台的比较不能只停留在材料属性上。本文集中回答三个问题：

1. 在相同几何、吃水和系泊系统条件下，材料改变如何影响平台质量分布、重心和固有周期？
2. 这些变化会怎样传递到平台运动、塔底前后向弯矩和机舱加速度？
3. 面对风浪联合响应时，混凝土与钢平台各自适合作为怎样的设计选择，而不是简单地谁全面更优？
...
![论文图 10 FAST 仿真器框架](../../assets/public-safe/ref-li2022-SOS/fig-10-fast-framework.png)
...
**针对问题 1，在相同尺寸、吃水和系泊布置下，混凝土平台本体质量更大，因此达到目标吃水所需压载水较少；钢平台本体质量更小，需要更多压载水，最终使 HSP3 的重心低于 LCP3。**
...
**针对问题 2，规则波结果中，LCP3 和 HSP3 在纵荡和垂荡 RAO 上差异很小，但纵摇 RAO 出现明显差别。**低重心的 HSP3 在部分周期范围内纵摇较小，不过当波浪周期接近结构固有周期时，响应增长会提前出现。

![论文图 12 LCP3 与 HSP3 模型的响应幅值算子对比](../../assets/public-safe/ref-li2022-SOS/fig-12-rao-comparisons.png)
...
**针对问题 2，在非规则波和风浪联合作用下，LCP3 和 HSP3 的差异不再表现为简单的“某一种材料全面更优”。**论文指出，HSP3 在平台纵摇运动和由纵摇引起的塔底载荷方面有优势，但在波频响应中又可能出现相反趋势。

![论文图 26 组合随机风浪条件下风机结构动力学统计数据](../../assets/public-safe/ref-li2022-SOS/fig-26-structural-dynamics-statistics.png)
...
**针对问题 3，从动力性能角度看，LCP3 混凝土平台具有较长纵摇固有周期，能让固有周期远离部分入射波周期；在一阶水动力载荷诱导的塔底载荷和机舱加速度方面也有较小响应。**相应地，它的平均平台纵摇和二阶水动力载荷诱导的纵摇振荡更大。
