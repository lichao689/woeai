...
| 2026-06-10 | WOEAI 公众号论文文章如果介绍英文期刊论文，“英文摘要”段必须与 Zotero `abstractNote`、PDF abstract 或其他已批准原文来源一致，不使用英文转述或 public-safe paraphrase 替代；生成与复核时应检查英文摘要与原文差异。 | WOEAI 公众号论文文章 | 对话确认 | 新增 |
